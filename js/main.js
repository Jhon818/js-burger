...
let ingredients = {
    ...
    'mustard': document.getElementById("mustard"),
    ...
    if (burgerName.value == "") {
        ...
        for (let ingredient in ingredients) {
            if (ingredients[ingredient].checked) {
                x += parseInt(ingredients[ingredient].value);
...
function sales(total) {
    if (coupon.value == "nnfno123" || coupon.value == "ononno123") {
        document.getElementById("price").innerHTML = '$' + (total * sale);
    }
    else {
